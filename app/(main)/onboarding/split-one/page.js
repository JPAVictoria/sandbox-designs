...
export default function OnboardingSplitOnePage() {
  ...
  const handleFinish = () => {
    ...
    router.push("/design-one/dashboard");
  };
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    !isActive && isDone && "text-foreground hover:bg-background/60",
                ...
                >
                  <span
                    className={cn(
                      ...
                      !isActive && !isDone && "bg-border text-muted-foreground"
                    )}
                  >
