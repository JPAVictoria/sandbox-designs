...
export default function DesignTwoOnboardingPage() {
  ...
  return (
    <div className="theme-blue min-h-screen bg-background">
      <div className="mx-auto flex min-h-screen max-w-3xl flex-col px-6 py-10">
        ...
        <div className="mb-8 flex items-center gap-5 rounded-2xl border border-border p-5">
          <ScoreRing score={progress} size={60} strokeWidth={5} />
            ...
            {STEPS.map((s, index) => {
              ...
              return (
                <button
                  ...
                  disabled={index > step}
                  className={cn(
                    "relative flex size-9 items-center justify-center rounded-xl transition-colors disabled:cursor-not-allowed",
        ...
        <div className="flex-1 rounded-2xl border border-border p-6 sm:p-8">
          {activeStep.id === "about" ? (
            <StepSection
