...
const STEPS = [
  {
    ...
    icon: User,
    context:
      "A little context so we can start narrowing down what fits — nothing here is set in stone.",
  },
  {
    id: "skills",
    label: "Skills",
    icon: ListChecks,
    context:
      "This is what your match score leans on most. The more specific, the sharper your matches.",
  },
  {
    id: "background",
    ...
    icon: GraduationCap,
    context:
      "No work experience yet? Completely fine — we'll match mostly on your skills instead.",
  },
  {
    id: "preferences",
    label: "Preferences",
    icon: Target,
    context: "Roles you'd want to be matched with. Changeable anytime later.",
  },
  {
    id: "resume",
    label: "Resume",
    icon: FileText,
    context:
      "Optional, but it gives the strongest starting signal before you've saved anything.",
  },
  {
    id: "review",
    label: "Review",
    icon: Sparkles,
    context: "One last look before we start finding matches for you.",
  },
];
...
export default function OnboardingSplitScreenPage() {
    ...
    <div className="grid min-h-screen bg-background lg:grid-cols-[380px_1fr]">
      <aside className="relative hidden flex-col justify-between overflow-hidden bg-primary p-10 text-primary-foreground lg:flex">
        ...
        <div className="relative">
          ...
          <h1 className="mt-8 max-w-[15ch] text-2xl font-semibold tracking-tight sm:text-3xl">
            Let&apos;s set up your profile
          </h1>
          <p className="mt-3 max-w-[30ch] text-sm text-primary-foreground/75">
            Six quick steps before we start finding jobs that actually fit.
          </p>
        </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="mx-auto flex w-full max-w-xl flex-1 flex-col px-6 py-10 sm:py-12">
