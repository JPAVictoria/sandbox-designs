...
export default function DesignThreeOnboardingPage() {
        ...
        {activeStep.id === "preferences" ? (
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Roles you&apos;d want to be matched with. You can change these
        ...
        {activeStep.id === "resume" ? (
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Optional, but it gives the strongest starting signal for your
                matches — especially before you&apos;ve saved or applied to
                anything.
              </p>
            </div>
            <div className="border-t border-border pt-6">
