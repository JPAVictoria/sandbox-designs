...
// Mirrors components/design-nine/timeline-entry.jsx's dot + connecting-line
// geometry, extended to double as clickable step navigation.
function TimelineStep({ step, index, isActive, isDone, isLast, isReachable, onSelect }) {
  ...
  return (
    <div className="relative flex gap-4 pb-6 last:pb-0">
      ...
      <button
        ...
        className={cn(
          "z-10 flex size-7 shrink-0 items-center justify-center rounded-full border text-primary transition-colors",
          isDone && "border-primary bg-primary text-primary-foreground",
          isActive && !isDone && "border-primary bg-background ring-4 ring-primary/15",
      ...
      <button
        ...
        disabled={!isReachable}
        className={cn(
          "min-w-0 flex-1 pt-1 text-left text-sm transition-colors",
          isActive ? "font-medium text-foreground" : "text-muted-foreground hover:text-foreground",
          !isReachable && "cursor-not-allowed opacity-60 hover:text-muted-foreground"
        )}
      >
        {step.label}
      </button>
...
export default function DesignNineOnboardingPage() {
  ...
  const handleFinish = () => {
    ...
    router.push("/design-nine/dashboard");
  };
  ...
  return (
    <div className="theme-rose min-h-screen bg-background">
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 py-8">
        ...
        <div className="grid flex-1 gap-8 sm:grid-cols-[200px_1fr]">
