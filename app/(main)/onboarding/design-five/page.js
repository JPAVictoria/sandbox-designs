...
export default function DesignFiveOnboardingPage() {
  ...
  const handleFinish = () => {
    ...
    router.push("/design-five/dashboard");
  };
  ...
  return (
    <div className="theme-blue min-h-screen bg-background">
      <header className="bg-primary text-primary-foreground">
        <div className="mx-auto flex h-14 max-w-4xl items-center gap-3 px-4">
          ...
          <button
            type="button"
            onClick={handleSkip}
            className="ml-auto text-sm text-primary-foreground/70 hover:text-primary-foreground"
          >
            Skip onboarding
          </button>
        </div>
      ...
      <div className="mx-auto flex max-w-4xl flex-col px-4 py-8">
        <div className="mb-8 flex flex-wrap items-center justify-center gap-1 rounded-full border border-border bg-muted/40 p-1">
          {STEPS.map((s, index) => {
            ...
            return (
              <button
                ...
                disabled={index > step}
                className={cn(
                  "flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-medium transition-colors disabled:cursor-not-allowed",
                  isActive && "bg-primary text-primary-foreground",
                  !isActive && isDone && "text-foreground hover:bg-background",
              ...
              >
                ...
                >
                  {isDone && !isActive ? <Check className="size-2.5" /> : index + 1}
                </span>
