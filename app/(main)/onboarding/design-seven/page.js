...
export default function DesignSevenOnboardingPage() {
  ...
  const handleFinish = () => {
    ...
    router.push("/design-seven/dashboard");
  };
  ...
  return (
    <div className="theme-purple min-h-screen bg-background">
      <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border px-4 sm:px-6">
        ...
        <div className="flex h-8 flex-1 max-w-sm items-center gap-2 rounded-lg border border-input bg-transparent px-2.5 text-sm text-muted-foreground dark:bg-input/30">
      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
          ...
          {STEPS.map((s, index) => {
            ...
            return (
              <button
                ...
                disabled={index > step}
                className={cn(
                  "flex items-center gap-1.5 border-l-2 border-transparent py-1 pl-2 text-xs transition-colors disabled:cursor-not-allowed",
                  isActive && "border-primary font-medium text-foreground",
                  !isActive && isDone && "text-foreground hover:border-foreground/30",
        ...
        <div className="border-t border-border pt-8">
          {activeStep.id === "about" ? (
            ...
            >
              <div className="flex items-center gap-3 border-l-2 border-primary/40 pl-3">
            ...
            >
              <div className="space-y-3">
                ...
                {education.map((item, index) => (
                  <div
                    key={index}
                    className="grid gap-2 border-l-2 border-transparent pl-3 hover:border-primary/30 sm:grid-cols-3"
                  >
                    <Input
                      value={item.school}
                      onChange={(event) =>
          ...
          {activeStep.id === "resume" ? (
            ...
            >
              {resumeFileName ? (
                ...
                <label className="flex cursor-pointer flex-col items-center gap-2 rounded-lg border border-dashed border-border p-8 text-center hover:border-primary/40 hover:bg-accent/30">
