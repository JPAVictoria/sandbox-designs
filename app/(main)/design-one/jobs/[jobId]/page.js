      ...
      <EmptyState
        ...
        action={
          <Button asChild size="sm" variant="outline">
            <Link href="/design-one/jobs">Back to Jobs</Link>
          </Button>
        }
      />
    );
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-3">
        <div className="space-y-6 md:col-span-2">
          ...
          <section>
            <div className="mb-2 flex items-center justify-between">
              ...
              {hasGapReport ? (
                <Link
                  href={`/design-one/skill-gaps?job=${job.id}`}
        ...
        <aside className="space-y-4 rounded-lg border border-border p-4">
          <div>
            ...
            <MatchScore score={job.matchScore} size="lg" className="mt-1" />
          </div>
          <div className="space-y-3 border-t border-border pt-4">
            <ScoreRow label="Semantic similarity" value={job.semanticScore} />
            <ScoreRow
              label="Personalized signal"
              value={job.collaborativeScore}
            />
          </div>
