...
function ApplicationRow({ row, onStatusChange, onAddTag, onRemoveTag, onSetInterviewDate, onRemove }) {
  ...
  return (
    <div className="rounded-md p-3 hover:bg-muted/60">
        ...
        <EmptyState
          ...
          action={
            <Button asChild size="sm" variant="outline">
              <Link href="/design-four/jobs">Browse jobs</Link>
            </Button>
          }
        />
      )}
