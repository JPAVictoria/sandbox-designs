...
function ApplicationCard({ row, onStatusChange, onAddTag, onRemoveTag, onSetInterviewDate, onRemove }) {
        ...
        <EmptyState
          ...
          action={
            <Button asChild size="sm" variant="outline">
              <Link href="/design-two/jobs">Browse jobs</Link>
            </Button>
          }
        />
      )}
